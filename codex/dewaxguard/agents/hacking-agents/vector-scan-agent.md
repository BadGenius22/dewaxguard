...
- `~/.agents/skills/dewaxguard/prompts/{LANGUAGE}/phase4b-lowlevel-templates.md` — language-specific low-level attack patterns
- `~/.agents/skills/dewaxguard/prompts/{LANGUAGE}/phase4b-runtime-templates.md` — language-specific runtime/execution patterns
