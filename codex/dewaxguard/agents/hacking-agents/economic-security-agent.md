...
For the detected language, read `~/.agents/skills/dewaxguard/prompts/{LANGUAGE}/phase4b-runtime-templates.md` section F-K for language-specific economic surfaces.
