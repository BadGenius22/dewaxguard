...
When `Platform: immunefi` is set in applicable AGENTS.md, legacy CLAUDE.md, or the contest scope, the validator translates DewaxGuard L1 matrix entries to Immunefi categories. Mapping:
