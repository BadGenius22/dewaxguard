...
Projects may declare their own realism filter in applicable `AGENTS.md` or legacy `{PROJECT_ROOT}/CLAUDE.md` under a "Realism filter" section. Higher-precedence applicable instructions override platform defaults.
...
When the orchestrator reads applicable instructions during preflight, it MUST:
