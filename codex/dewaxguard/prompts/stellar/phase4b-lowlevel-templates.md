...
>
> **🚨 REQUIRED READING**: Before starting, the agent must read `~/.agents/skills/dewaxguard/platform-quirks/stellar.md`. Stellar has critical state archival semantics that differ from common auditor assumptions and have historically produced invalid findings.
...
Do NOT report findings based on the following misconceptions. See `~/.agents/skills/dewaxguard/platform-quirks/stellar.md` for the complete list:
