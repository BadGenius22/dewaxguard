...
Spawn 6 depth agents in parallel via Codex subagent delegation. The standard 4 (Plamen-style) focus on business logic; the 2 NEW agents focus on language and runtime semantics.
...
For each agent, use this Codex subagent delegation invocation template:
