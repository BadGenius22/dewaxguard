...
Spawn through Codex delegation with a unique task name, `fork_turns="none"`, and high reasoning effort for core/thorough or medium for light:
...
Spawn via Codex subagent delegation:
...
- Otherwise (max 1 iteration in v1.13.1, hard cap 2): spawn one more Codex subagent targeting just the unexplored pairs, then append results to `chain_hypotheses.md`
