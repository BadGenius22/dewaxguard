...
- **Spawned agent**: bounded mechanical Codex subagent, reading the convention catalog as input and producing the outlier list as output
- **Cost**: 1 worker agent per 5 conventions
