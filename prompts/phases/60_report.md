...
- Platform: <from CLAUDE.md Platform: line; default = unspecified>
...
### Agent 2 — Critical+High tier writer (opus)
...
### Agent 3 — Medium tier writer (sonnet)
...
### Agent 4 — Low+Info tier writer (sonnet)
...
Spawn agents 2, 3, 4 in PARALLEL (one message, three Task calls).

### Agent 5 — Assembler (haiku for ≤ 25 findings, sonnet for > 25)

```
Task(
  subagent_type="general-purpose",
  model="<haiku_or_sonnet_based_on_count>",
  prompt="
